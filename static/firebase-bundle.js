...
<rect width="24" height="24" fill="white"/>
  ...
  var init_index_esm = __esm({
    "node_modules/@firebase/util/dist/index.esm.js"() {
      ...
      getExperimentalSetting = (name7) => getDefaults()?.[`_${name7}`];
      Deferred = class {
        constructor() {
          this.reject = () => {
          };
  ...
  function getAnalytics(app = getApp2()) {
  ...
  function initializeAppCheck(app = getApp2(), options) {
    app = getModularInstance(app);
  ...
  var APP_CHECK_STATES, DEFAULT_STATE, DEBUG_STATE, BASE_ENDPOINT, EXCHANGE_RECAPTCHA_TOKEN_METHOD, EXCHANGE_DEBUG_TOKEN_METHOD, TOKEN_REFRESH_TIME, ONE_DAY, Refresher, ERRORS3, ERROR_FACTORY4, DB_NAME3, DB_VERSION3, STORE_NAME2, DEBUG_TOKEN_KEY, dbPromise3, logger3, defaultTokenErrorData, AppCheckService, name6, version6, RECAPTCHA_URL, ReCaptchaV3Provider, APP_CHECK_NAME, APP_CHECK_NAME_INTERNAL;
        ...
        async getToken() {
          ...
          try {
            ...
            if (e.code?.includes(
              ...
              throw ERROR_FACTORY4.create("initial-throttle", {
  ...
  // firebase-entry.js
  var require_firebase_entry = __commonJS({
    "firebase-entry.js"() {
      init_index_esm5();
      init_index_esm8();
      init_index_esm9();
      ...
      var RECAPTCHA_SITE_KEY = "6Lfi-UUsAAAAALVa4-MIVKWmfy7P7wMR0jZRa9KY";
      var app;
      var analytics;
      var auth;
      var googleProvider;
